...
# Buttons
button1 = Button(tab1,text='Reset',command=clear_text,width=12,bg='#cd201f',fg='#fff')
button1.grid(row=4,column=0,pady=10,padx=10)

button2 = Button(tab1,text='Summarize',command=get_summary,width=12,bg='#cd201f',fg='#fff')
button2.grid(row=4,column=1,pady=10,padx=10)

button3 = Button(tab1,text='Clear Result',command=clear_display_result,width=12,bg='#cd201f',fg='#fff')
...
b0=Button(tab2,text="Open File", width=12,command=openfiles,bg='#cd201f',fg='#fff')
b0.grid(row=3,column=0,padx=10,pady=10)

b1=Button(tab2,text="Reset ", width=12,command=clear_text_file,bg="#cd201f",fg='#fff')
b1.grid(row=3,column=1,padx=10,pady=10)

b2=Button(tab2,text="Summarize", width=12,command=get_file_summary,bg='#cd201f',fg='#fff')
b2.grid(row=3,column=2,padx=10,pady=10)

b3=Button(tab2,text="Clear Result", width=12,command=clear_text_result,bg='#cd201f',fg='#fff')
b3.grid(row=5,column=1,padx=10,pady=10)

b4=Button(tab2,text="Close", width=12,command=window.destroy,bg='#cd201f',fg='#fff')
...
# BUTTONS
button1=Button(tab3,text="Reset",command=clear_url_entry, width=12,bg='#cd201f',fg='#fff')
button1.grid(row=4,column=0,padx=10,pady=10)

button2=Button(tab3,text="Get Text",command=get_text, width=12,bg='#cd201f',fg='#fff')
button2.grid(row=4,column=1,padx=10,pady=10)

button3=Button(tab3,text="Clear Result", command=clear_url_display,width=12,bg='#cd201f',fg='#fff')
button3.grid(row=5,column=0,padx=10,pady=10)

button4=Button(tab3,text="Summarize",command=get_url_summary, width=12,bg='#cd201f',fg='#fff')
...
# BUTTONS
button1=Button(tab4,text="Reset",command=clear_compare_text, width=12,bg='#cd201f',fg='#fff')
button1.grid(row=4,column=0,padx=10,pady=10)

button2=Button(tab4,text="SpaCy",command=use_spacy, width=12,bg='#cd201f',fg='#fff')
button2.grid(row=4,column=1,padx=10,pady=10)

button3=Button(tab4,text="Clear Result", command=clear_compare_display_result,width=12,bg='#cd201f',fg='#fff')
button3.grid(row=5,column=0,padx=10,pady=10)

button4=Button(tab4,text="NLTK",command=use_nltk, width=12,bg='#cd201f',fg='#fff')
button4.grid(row=4,column=2,padx=10,pady=10)

#button4=Button(tab4,text="Gensim",command=use_gensim, width=12,bg='#03A9F4',fg='#fff')
#button4.grid(row=5,column=1,padx=10,pady=10)

button4=Button(tab4,text="Sumy",command=use_sumy, width=12,bg='#cd201f',fg='#fff')
button4.grid(row=5,column=2,padx=10,pady=10)


#variable = StringVar()
#variable.set("SpaCy")
#choice_button = OptionMenu(tab4,variable,"SpaCy","Sumy","NLTK")
